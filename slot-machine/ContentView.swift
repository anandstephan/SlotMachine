...
//  slot-machine
//
//  Created by Anand Stephan on 06/03/24.
//
...
struct ContentView: View {
    @State public var symbols = ["love","happy","scary"]
    ...
    var body: some View {
        ZStack{
            ...
            .alert(item: $showingAlert){
                ...
                switch alert{
                case .sucess:
                    return Alert(title: Text("Yahh!! you won"), message: Text("Born with Charm"), dismissButton:  .cancel())
                case .failure:
